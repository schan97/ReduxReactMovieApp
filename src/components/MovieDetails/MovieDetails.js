...
import { fetchAsyncTitleDetails, getTitleDetails, removeTitleDetails } from '../../features/movies/movieSlice';
...
const MovieDetails = () => {
  ...
  useEffect(() => {
    ...
    // Clean up function to clear the details
    return () => {
      dispatch(removeTitleDetails());
    };
  ...
  return (
    <div className='title-section'>
      ...
      {/* If the data length is 0 show loading div, else display the data */}
